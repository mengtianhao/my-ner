...
class PositionalEmbedding(nn.Module):
    ...
    """
    def __init__(self, hidden_size, max_position_embedding=512, initializer_range=0.02):
        super(PositionalEmbedding, self).__init__()
        self.embedding = nn.Embedding(max_position_embedding, hidden_size)
...
class BertEmbeddings(nn.Module):
    def __init__(self, config):
        ...
        self.position_embeddings = PositionalEmbedding(max_position_embedding=config.max_position_embeddings,
                                                       hidden_size=config.hidden_size,
                                                       initializer_range=config.initializer_range)
